 ...
 */
 ...
 (function($){
    ...
    var ST = $.fn.scrollText = function(options) {
        ...
        contentChildMarginBottom = Math.floor(content.children().eq(0).css('margin-bottom').replace(/[^-\.0-9]/g, ""));
        contentChildHeight = content.children().eq(0).height() + parseInt(contentChildMarginBottom);
        console.log(contentChildHeight)
