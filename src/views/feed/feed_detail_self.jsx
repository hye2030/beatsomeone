        ...
        <section id="wrap_content" className="detail_page">
            <div className="wrap_inner">
                    ...
                    <div className="inner">
                        <div className="profile_box">
                            ...
                            <div>
                                ...
                                <p className="gray_text">13시간 전 (최근수정 : 3시간 전)</p>
                            </div>
                        </div>
                ...
                <div className="content_area">
                    <div className="inner">
                        <div className="title">
                            <p className="mark_self">자작곡</p>
                            음원 제목(or 파일명)이 출력됩니다.
                        </div>
                        <div className="play_box music">
                            <div className="wrapper">
                                <div className="sound_img"><img src="/src/assets/images/dummy/sound_img.png" alt=""/></div>
                                <div className="play_btn_wrap">
                                    <button type="button" className="play_btn stop"></button>
                                    <p className="play_time">4:16</p>
                                </div>
                            </div>
                            <button type="button" className="buy_btn">음원구매하기</button>
                        </div>
                        <div className="title">
                            <p className="mark_self">자작곡</p>
                            음원 제목(or 파일명)이 출력됩니다.
                        ...
                        <div className="play_box music">
                            <div className="wrapper">
                                <div className="sound_img"><img src="/src/assets/images/dummy/sound_img.png" alt=""/></div>
                                <div className="play_btn_wrap">
                                    <button type="button" className="play_btn"></button>
                                    <p className="play_time">4:16</p>
                                </div>
                            </div>
                            <button type="button" className="buy_btn">음원구매하기</button>
